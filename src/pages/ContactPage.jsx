...
export default function ContactPage() {
  const handleContactSubmit = (e) => {
    ...
    const whatsappUrl = `https://wa.me/919873603257?text=${encodeURIComponent(
      waMessage
    )}`;
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          We would love to hear from you. Book an appointment or inquire about
          our makeup courses.
        </p>
      </section>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
                {[
                  ...
                  },
                  {
                    ...
                    content: (
                      <a
                        href="mailto:bussinesswithnusrat@gmail.com"
                        style={{
                          color: "#555",
                          textDecoration: "none",
                          fontSize: "1rem",
                  ...
                  },
                  {
                    ...
                    content: (
                      <a
                        href="https://www.instagram.com/nusrat_makeupartistofficial?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
                        target="_blank"
                        rel="noreferrer"
                        style={{
                          color: "#555",
